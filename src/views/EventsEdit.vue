    ...
    <section>
      <div class="container">
        <div class="row">
          <!--  start blog left-->
          <div
            class="col-lg-8 col-md-12 padding-20px-top sm-margin-50px-bottom border-all box-shadow-light pagebox"
          >
            <form v-on:submit.prevent="editEvent">
              <h1 class="text-center">Edit an Event</h1>
              <ul>
            ...
            <button
              class="btn butn btn-block margin-20px-bottom"
